...
1.Character to numeric conversion leads to NAs because characters can't be interpreted as numbers.Because characters like "a", "b", etc. cannot be converted to numbers.

2.Factor to numeric conversion works by converting each factor level to its corresponding numeric code.                   